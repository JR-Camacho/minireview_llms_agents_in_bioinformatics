...
sobre sistemas basados en agentes aplicados a transcriptómica,
...
muestra una transición desde enfoques basados en \textit{prompting} hacia
arquitecturas agénticas capaces de planificar tareas, invocar herramientas
externas, ejecutar código, autocorregirse y coordinar agentes especializados.
Los principales hallazgos señalan que la
...
elementos centrales para escalar estos sistemas. Persisten desafíos
relacionados con alucinaciones, coste computacional, propagación de errores,
ausencia de benchmarks estandarizados y gobernanza científica. En conjunto, los
sistemas agénticos representan un cambio
de paradigma: no solo automatizan tareas repetitivas, sino que pueden funcionar
...
\input{sections/02_search_methodology}
\input{sections/03_thematic_synthesis}
